  ...
  <>
    ...
    <div className="md:flex items-center gap-6">
      <FormItem className="items-center justify-center w-full">
        ...
        <FormControl>
          <Input
            placeholder="Ethiopia, Addis Ababa, Bole"
    ...
    <div className="md:flex items-center gap-6">
      <FormItem className="items-center justify-center w-full">
        ...
        <FormControl>
          <Input
            placeholder="Bahirdar University, Software Engineering"
      ...
      <FormItem className="items-center justify-center w-full">
        ...
        <FormControl>
          <Input
            type="text"
            placeholder="Kuraz Tech, Addis Software, etc."
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="kirubelabrham@gmail.com"
