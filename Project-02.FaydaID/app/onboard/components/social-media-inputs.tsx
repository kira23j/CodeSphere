...
const SocialMediaInputs: React.FC<SocialMediaInputsProps> = ({
  ...
  <>
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://x.com/kirubelabrham"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.instagram.com/kirubelabrham"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.tiktok.com/@kirubelabrham"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.youtube.com/user/kirubelabrham"
    ...
    <FormItem className="items-center justify-center w-full">
      ...
      <FormControl>
        <Input
          placeholder="https://www.linkedin.com/in/kirubelabrham"
